...
void LavenderConsole::Render(bool wantVisible)
{
    ...
    if (polished) {
        ...
        dl->AddLine(
            ImVec2(wPos.x + 1.0f, wPos.y + headerH),
            ImVec2(wPos.x + w - 1.0f, wPos.y + headerH),
            LavenderHook::UI::Lavender::PolishedAccent(0.55f * alpha), 1.0f);
        ...
        ImGui::SetCursorPosY(headerH + 4.0f);
    }
